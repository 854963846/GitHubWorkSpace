...
package
{
	...
	{	
		...
		protected var theme : Object = { bg: 0x000033, fps: 0xffff00, ms: 0x00ff00, mem: 0x00ffff, memmax: 0xff0070, mouseX: 0x00ff00, mouseY: 0xffff00 }; 

		/**
		 * <b>Stats</b> FPS, MS and MEM, all in one.
		 * 
		 * @param _theme         Example: { bg: 0x202020, fps: 0xC0C0C0, ms: 0x505050, mem: 0x707070, memmax: 0xA0A0A0, mouseX: 0x00ff00, mouseY: 0xffff00 } 
		 */
		public function Stats( _theme : Object = null ) : void
		{
			if (_theme)
			{
				...
				if (_theme.mouseX != null) theme.mouseX = _theme.mouseX;
				if (_theme.mouseY != null) theme.mouseY = _theme.mouseY;
			}
			...
			//添加鼠标位置
			//xml = <xml><mouseX>mouseX:</mouseX><mouseY>mouseY:</mouseY><fps>FPS:</fps><ms>MS:</ms><mem>MEM:</mem><memMax>MAX:</memMax></xml>;
			...
			style.setStyle("mouseX", {color: hex2css(theme.mouseX)});
			style.setStyle("mouseY", {color: hex2css(theme.mouseY)});
		...
		private function update(e : Event) : void
		{
			...
			xml.mouseX = "mouseX: " + String(stage.mouseX);
			xml.mouseY = "mouseY: " + String(stage.mouseY);
